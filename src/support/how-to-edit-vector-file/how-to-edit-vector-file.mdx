...
## Usually the fonts that appear on the preview

- **Editing fonts**: Usually the fonts that appear on the preview file will not be available when you open the editable vector. To learn more about this, please check the information from this article.

For additional assistance regarding vector editing, you can visit the Adobe Illustrator support page.
